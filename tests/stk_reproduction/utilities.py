...
def get_mch_bonds(state: stk.ConstructedMolecule):  # noqa: ANN201
...
def get_long_bond_ids(state: stk.ConstructedMolecule):  # noqa: ANN201
    ...
    """
    for _i, bond_infos in enumerate(state.get_bond_infos()):
        ba1 = bond_infos.get_bond().get_atom1().get_id()
        ba2 = bond_infos.get_bond().get_atom2().get_id()
...
def get_subunits(state: stk.ConstructedMolecule):  # noqa: ANN201
